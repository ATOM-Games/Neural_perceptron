...
namespace Persik
{
    class Persika
    {
        public double[] VhodDann = new double[100];
        ...
        public void NewPers(int Vih) {
            ...
            this.hiddetDann = new double[(int)((100+VihodDann.Length)/2)];
            //---------------------------------
            wIH = new double[100][]; wHO = new double[hiddetDann.Length][];
            for (int v = 0; v < 100; v++){
